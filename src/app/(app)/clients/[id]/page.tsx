    ...
    <label className="relative group cursor-pointer shrink-0">
      {client.logoUrl ? (
        <img src={client.logoUrl} alt={client.name}
          className="h-20 w-20 rounded-2xl object-cover ring-1 ring-gray-200 bg-white" />
      ) : (
        <div
        ...
        {tab === "projects" && (
          <div className="max-w-4xl mx-auto">
            {client.projects && client.projects.length > 0 ? (
              ...
              <EmptyState icon={FolderOpen} title="No projects linked" desc="Create projects and assign this client in the Campaign/Client fields on the project form." />
            )}
          </div>
        )}
