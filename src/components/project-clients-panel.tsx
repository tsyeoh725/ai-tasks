        ...
        <div className="space-y-1">
          {clients.map((c) => (
            <div key={c.id} className="group flex items-center gap-2.5 px-2 py-1.5 rounded-lg hover:bg-gray-50 transition-colors">
              {c.logoUrl ? (
                <img src={c.logoUrl} alt={c.name} className="h-7 w-7 rounded-md object-cover ring-1 ring-gray-200 shrink-0" />
              ) : (
                <div
          ...
          {loading ? (
            ...
            <div className="max-h-72 overflow-y-auto space-y-1">
              {filtered.map((c) => (
                ...
                >
                  {c.logoUrl ? (
                    <img src={c.logoUrl} alt="" className="h-8 w-8 rounded-md object-cover ring-1 ring-gray-200 shrink-0" />
                  ) : (
                    <div
